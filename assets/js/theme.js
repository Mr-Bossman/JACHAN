...
function changePage(event) {
    ...
    if (new URL(location.href).searchParams.get('page') == el.children[0].innerHTML)
        return;
            ...
            for (mu in months) {
                for (p in yrProj) {
                    if (yrProj[p][2] == months[mu]) {
                        ...
                        newM.children[1].children[0].append(yrProj[p][0])
                        newM.children[1].children[0].children[0].innerHTML = yrProj[p][3]
